...
public class ModSpawnEggItem extends net.minecraft.item.SpawnEggItem
{
	...
	{
		final Map<EntityType<?>, net.minecraft.item.SpawnEggItem> EGGS = ObfuscationReflectionHelper.getPrivateValue(net.minecraft.item.SpawnEggItem.class, null, "field_195987_b");
		...
		DefaultDispenseItemBehavior dispenseBehaviour = new DefaultDispenseItemBehavior()
		{
			...
			protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
			{
				...
				EntityType<?> type = ((net.minecraft.item.SpawnEggItem) stack.getItem()).getType(stack.getTag());
		...
		for (final net.minecraft.item.SpawnEggItem spawnEgg : UNADDED_EGGS)
		{
