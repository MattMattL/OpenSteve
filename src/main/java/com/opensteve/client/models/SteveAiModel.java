...
public class SteveAiModel extends HumanoidModel<EntitySteveAi>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(OpenSteve.MODID, "steve_ai"), "main");

    public SteveAiModel(ModelPart model)
    {
        super(model);
    }
    ...
    public static MeshDefinition createMesh(CubeDeformation deform, float p_170683_)
    {
        ...
        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, deform), PartPose.offset(-5.0F, 2.0F + p_170683_, 0.0F));
        partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, deform), PartPose.offset(5.0F, 2.0F + p_170683_, 0.0F));
